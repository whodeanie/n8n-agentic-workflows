...
The portfolio should describe the repo as a validated n8n workflow library and avoid implying these are hosted live services. The strongest claims are the measurable ones: forty-five workflow exports, TypeScript catalog generation, Python test coverage, CI validation, and clear import/setup docs.
